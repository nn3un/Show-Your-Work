...
public class IdeInitializer implements BaseComponent {
    ...
    private Logger logger = LogManager.getLogger("IdeInitializer");
    ...
    private void addEditorFactoryListener() {
        ...
        editorFactory.addEditorFactoryListener(new EditorFactoryListener() {
            ...
            public void editorCreated(@NotNull EditorFactoryEvent editorFactoryEvent) {
                ...
                if (file == null || !file.getName().endsWith(".py") || IdeInitializer.notificationOpen.containsKey(document) || IdeInitializer.hasDocumentListener.containsKey(document)) {
            ...
            public void editorReleased(@NotNull EditorFactoryEvent editorFactoryEvent) {
                ...
                if (notificationOpen.containsKey(documentClosed)) {
                    ...
                    IdeInitializer.notificationOpen.get(documentClosed).expire();
                    IdeInitializer.notificationOpen.remove(documentClosed);
                }
    ...
    private void addEditorTabChangedListener() {
        ...
        connection.subscribe(FileEditorManagerListener.FILE_EDITOR_MANAGER, new FileEditorManagerListener() {
            ...
            public void selectionChanged(@NotNull FileEditorManagerEvent event) {
                ...
                StatusBar statusBar = WindowManager.getInstance().getStatusBar(event.getManager().getProject());
                if (statusBar == null) {
                    return;
                }
    ...
    private void initializeListeners(Editor editor) {
        ...
        CopyPasteListener copyPasteListener = new CopyPasteListener(editor, logFilePath);
        MessageBus bus = ApplicationManager.getApplication().getMessageBus();
        MessageBusConnection connection = bus.connect();
